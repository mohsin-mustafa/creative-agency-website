...
const NewNavbar = () => {
    ...
    let Links = [
        { name: "Home", link: "/", color: "green-500" },
        { name: "Works", link: "/works", color: "blue-500" },
        { name: "About", link: "/about", color: "red-500" },
        ...
        <nav className="container relative my-7 ">
            <div className="flex items-center justify-between">
                    ...
                    {Links.map((link, i) => {
                        return (
                            <li className="md:ml-8  md:my-0 my-7 list-none">
                                <a
                                    href={link.link}
                                    className={`text-${link.color} font-Poppins font-semibold text-[20px] leading-7 hover:text-[#FCE611] duration-500`}
                                >
                                    {link.name}
                                </a>
                            </li>
                ...
                <div className="hidden lg:block ">
                    <button
                        type="button"
                        className="text-[#FFFFFF]  font-Poppins font-semibold text-[16px] leading-[26px] 
